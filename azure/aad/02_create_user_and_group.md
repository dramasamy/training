...
- **Groups**. Optionally, you can add the user to one or more existing groups. You can also add the user to groups at a later time.![Add to Group](images/10_groups_and_roles.jpg) 
- Select a group for the user. ![Add to grou](images/11_assign_group.jpg)
- **Job info**: You can add more information about the user here, or do it later. This user can be part of the **dynmaic** group you created in the previous lab by setting the department to **mobility** ![job info](images/12_job_info.jpg)
